...
decorative_tiles = pygame.image.load(
    fixpath("assets/images/tiles-images/decorative_tiles.png")
)
...
def crop_tile(style, ID):
    ...
    tile_surf.blit(tiles, (0, 0), (tile_posx, tile_posy, TILESIZE, TILESIZE))
    return tile_surf
